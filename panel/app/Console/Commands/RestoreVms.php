...
class RestoreVms extends Command
{
    ...
    private function restoreApp(App $app, VMManagerClient $vmManager, EnvironmentVariableService $envService): void
    {
        ...
        if (is_dir($buildDir)) {
            ...
            $result = $vmManager->deployCode($vmId, $buildDir, $envContent, $caddyContent, $app->persistent_paths ?? [], $workersConfig, null, null, $app->cron_enabled, $app->sqlite_databases ?? [], $app->slug, $app->effectiveStorageEndpoint());
